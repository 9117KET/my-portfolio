...
function App() {
  ...
  return (
    <ThemeProvider>
      ...
      <div className="font-body text-sm sm:text-base md:text-lg bg-surface text-on-surface min-h-screen transition-colors duration-200 relative bg-pattern">
        {/* Navigation loading overlay to prevent white flash */}
        {isNavigating && (
          <div className="fixed inset-0 bg-surface z-40 transition-opacity duration-200"></div>
        )}
        <Outlet />
