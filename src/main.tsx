...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/' element={<App />}>
      ...
      <Route path='projects' element={<Projects/>} /> {/* Route for the Projects page*/}
      <Route path='experience' element={<Experience/>} /> {/* Route for the Experience page*/}
      <Route path='blog' element={<Blog/>} /> {/* Route for the Blog page*/}
      <Route path='blog/:postId' element={<BlogPostPage/>} /> {/* Route for individual Blog posts*/}
...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    <HelmetProvider> {/* Provides a context for managing changes to the document head*/}
