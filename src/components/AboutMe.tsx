        ...
        <div className="mt-5 mb-[-2%] p-6 sm:p-8 dark:text-gray-300 font-mono max-w-full overflow-hidden">
            ...
            <div className="mt-10">
                ...
                <div className="mt-8">
                    ...
                    {/* Personal statements */}
                    <p className="pl-2 md:pl-6 text-xs sm:text-sm md:text-lg dark:text-gray-300"><span className="text-blue-500">| </span>I enjoy teaching(started teaching maths and further maths in High School, then calculus and linear algebra at university), problem solving and learning new things.</p>
