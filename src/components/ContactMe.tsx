...
const contactIcons: Record<string, (className?: string) => JSX.Element> = {
...
export default function ContactMe() {
  return (
    <Card className="mt-10" variant="elevated">
      ...
      <p className="mb-6 text-sm sm:text-base text-on-surface-variant">
        I'm open to discussing projects, opportunities, or collaborations. Reach
